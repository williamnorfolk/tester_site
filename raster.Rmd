...
lines <- rejoin %>% ggplot() +
  ...
  annotate("pointrange", x = 14.18783, y = 1.5, ymin = 0.95, ymax = 2.05, color = "red", size =1) +
  theme_classic() +
  xlab("Log Viral Load")
...
lines <- lines +   
  ...
  labs(caption = "This Week's Viral Load 1.72e+14 Copies")
...
perc.rank(rejoin$log_sum_copies_both, 14.18783)
```
