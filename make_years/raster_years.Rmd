...
lines <- rejoin_all %>% ggplot() +
  ...
  annotate("pointrange", x = 13.05193, y = 1.5, ymin = 0.95, ymax = 2.05, color = "red", size =1) +
  theme_classic() +
  xlab("Log Viral Load")
...
lines <- lines +   
  ...
  labs(caption = "This Week's Viral Load 1.13e+13 Copies")
...
perc.rank(rejoin_all$log_sum_copies_both, 13.05193)
```
