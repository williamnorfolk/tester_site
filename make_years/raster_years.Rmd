...
lines <- rejoin_all %>% ggplot() +
  ...
  annotate("pointrange", x = 12.51995, y = 1.5, ymin = 0.95, ymax = 2.05, color = "red", size =1) +
  theme_classic() +
  xlab("Log Viral Load")
...
lines <- lines +   
  ...
  labs(caption = "This Week's Viral Load 3.31e+12 Copies")
...
perc.rank(rejoin_all$log_sum_copies_both, 12.51995)
```
