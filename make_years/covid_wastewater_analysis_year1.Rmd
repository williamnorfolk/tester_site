---
title: "covid_wastewater_analysis_year1"
...
```{r}
save(p_combined, file = "./site_objects/all_data_year1.rda")
```
...
```{r}
rejoin <- readRDS("./rejoin_year1.rds")
```
...
```{r}
save(smooth_extract, file = "./site_objects/data_trends_year1.rda")
```


No last 6weeks plot for the past year
