...
This week, we are reporting concentrations of SARS‑CoV‑2 in wastewater collected from two sampling events (~6:30 am Sunday Nov 1 to ~ 6:30 am Monday Nov. 2 and ~6:30 am Tuesday Nov. 3 to ~6:30 am Wednesday Nov. 4, 2020). The increased in sampling frequency is intended to improve the resolution of our data.  

There was a notable difference in the trends based on the two gene targets, with viral gene copies attributed to the N1 gene increasing slightly or staying steady (especially at WRF B) and viral gene copies attributed to the N2 gene declining (with most samples at or below the limit of our detection). Detection rates of the two genes can vary, especially in wastewater; therefore, it is important to consider results of these targets together. In combination, these results suggest that SARS&#8209;CoV&#8209;2 loads are stable or may be declining.   
