...
<span style="text-decoration:underline">**Key Weekly Update:**</span> **SARS&#8209;CoV&#8209;2 load for the week, across all plants increased this week compared to last. This was consistent for both sampling days, and was largely due to increase load at WRF B (receives wastewater from areas west of Milledge Ave.) and a single day increase at WRF A (wastewater from UGA, downtown, and northern areas of Athens). Unlike prior week, both SARS&#8209;CoV&#8209;2 gene targets (N1 and N2) were detected in all samples. We are still considering levels to be steady but are keeping watch to determine when we may be seeing the start of an inflection point. As of 4/15, the 7-day running average of new cases reported in Athens-Clarke County increased slightly to 5 per day.**    
