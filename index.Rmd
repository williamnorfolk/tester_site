...
_Please Note_ This website is a **tester** for page layout and data visualization for the Lipp Lab COVID Wastewater monitoring project. The data on this page are not peer-reviewed or finalized for public release and thus should not be interpreted as such. If you are interested in viewing the final data from this project please visit [this website](https://lipplab-uga.github.io/covid_wastewater_lipplab_athens/). 

<div style="margin-bottom:25px;">
</div>

<style>
div.blue { background-color:#AFE1AF; border-radius: 5px; padding: 15px;}
</style>
<div class = "blue">
Thank you for visiting our page!

As of January 1, 2023 wastewater surveillance for SARS&#8209;CoV&#8209;2 in Athens-Clarke County has been moved to the GA Department of Public Health and CDC monitoring programs. Data for Athens-Clarke county will continue to be collected weekly and will be available at [the DPH website](https://dph.georgia.gov/covid-19-status-report) and [the CDC website](https://covid.cdc.gov/covid-data-tracker/#wastewater-surveillance). We would like to thank everyone who has followed our data collection over the past three years and all who have contributed to success of this program. All data/figures posted to this page will remain available online as an archival reference. A direct link to this page can be found at our Lab's [Github page](https://lipplab-uga.github.io/covid_wastewater_lipplab_athens/) and all data/code can be found in our [GitHub repository](https://github.com/lipplab-uga/covid_wastewater_lipplab_athens).
</div>
...
<span style="text-decoration:underline">Data views:</span>   
•	**Full Study**: _06/30/2020_ to _present_     
•	**Year 1**: _06/30/2020_ to _06/29/2021_     
•	**Year 2**: _06/30/2021_ to _present_   
...
load(file = "./make_years/site_objects/data_trends_both_years.rda")
smooth_extract
```
#### Current Weekly Trends

<span style="text-decoration:underline">**Key Weekly Update: **</span>**[placeholder]**      
...
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/data_trends_year2.rda")
smooth_extract
```
...
##### Apr 11 & 13
<span style="text-decoration:underline">**Key Weekly Update:**</span> **SARS&#8209;CoV&#8209;2 load for the week, across all plants increased this week compared to last. This was consistent for both sampling days, and was largely due to increase load at WRF B (receives wastewater from areas west of Milledge Ave.) and a single day increase at WRF A (wastewater from UGA, downtown, and northern areas of Athens). Unlike prior week, both SARS&#8209;CoV&#8209;2 gene targets (N1 and N2) were detected in all samples. We are still considering levels to be steady but are keeping watch to determine whether we may be seeing the start of an inflection point. As of 4/15, the 7-day running average of new cases reported in Athens-Clarke County increased slightly to 5 per day.**    
...
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/past6_year2.rda")
...
#### WRF A
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/wrf_a_year2.rda")
p_wrf_a
```
...
#### WRF B
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/wrf_b_year2.rda")
p_wrf_b
```
...
#### WRF C
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/wrf_c_year2.rda")
p_wrf_c
```
...
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/all_data_year2.rda")
p_combined
```
...
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/data_trends_year1.rda")
smooth_extract
```
...
**Note about chart and methods**.    
The viral load estimated is based on the average concentration of the SARS&#8209;CoV&#8209;2 gene copies per liter of wastewater (as determined by the N1 and N2 viral nucleocapsid genes) x the total flow of wastewater over the sampling day. Both genes target the SARS&#8209;CoV&#8209;2 genome but have slight differences in how they perform in our tests; therefore, we are averaging them to simplify the interpretation of the viral load. The trend lines were calculated using locally estimated scatterplot smoothing (LOESS, span = 0.25). The error associated with these estimates (the 95% confidence interval) is displayed as the shaded area. 
...
<span style="text-decoration:underline">Mar 15 & 17</span>  
...
#### WRF A
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/wrf_a_year1.rda")
p_wrf_a
```
...
#### WRF B
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/wrf_b_year1.rda")
p_wrf_b
```
...
#### WRF C
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/wrf_c_year1.rda")
p_wrf_c
```
...
```{r out.height = "500%", out.width = "100%", echo=FALSE, message=FALSE, warning=FALSE}
load(file = "./make_years/site_objects/all_data_year1.rda")
p_combined
```
...
Megan Lott, PhD Candidate

William Norfolk, PhD Candidate 
