...
This week, we are reporting concentrations of SARS&#8209;CoV&#8209;2 in wastewater collected from two sampling events (November 2 and November 4, 2020). The increased in sampling frequency is intended to improve the resolution of our data.  

This week’s results indicate that the concentration of SARS&#8209;CoV&#8209;22 has decreased from the previous week. In some samples, the levels of SARS&#8209;CoV&#8209;22 virus are near or below the limit of detection for our current method. Our theoretical limit of detection is approximately 3,570 copies/L. Below this concentration, viruses may be not be detected or quantified with accuracy.  
