...
This week, levels of SARS&#8209;CoV&#8209;2 for both targets exceed 1 million copies of virus per liter of sewage. These values are consistent with those reported from WRF B in the previous week (September 1, 2020), but do reflect a 10-fold reduction of viruses from wastewater collected from WRF A.  

This reduction may be explained by the recent Labor Day holiday. The wastewater influent flow volume at WRF A decreased from 5.73 million gallons on September 1, 2020 to 4.96 million gallons on September 8, 2020. WRF A collects wastewater from the University and from Downtown Athens. Composite samples were collected between Monday and Tuesday morning, during which times the University campus facilities were closed.    

We are examining ways to calibrate our estimations of SARS&#8209;CoV&#8209;2 concentrations to consider these changes in influent flow volume.   
