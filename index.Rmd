...
Viral load for Tuesday 2/2 through Wednesday 2/3, was virtually unchanged from the Monday sample. (Please note that these data only include WRF A and B as of the 2/5 update. The WRF C sample is currently being re-processed and results will be updated accordingly. However, WRF C is the smallest of the three plants and we do not expect the total change much).  
