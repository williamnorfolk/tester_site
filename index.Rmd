...
<span style="text-decoration:underline">**Key Weekly Update: **</span>**SARS&#8209;CoV&#8209;2 vViral loads were stable this week compared to last week; however, levels remain high (once again reaching the 70th percentile of all samples collected to date). Cases reported to the GA DPH also changed very little from last week, with 31 new cases per day (using a 7-day moving average). Wastewater levels confirm the high transmission levels for Athens-Clarke County noted by the CDC.**      
