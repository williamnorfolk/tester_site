...
<span style="text-decoration:underline">**Key Weekly Update:**</span> **Following the increase in SARS&#8209;CoV&#8209;2 load in last week’s wastewater samples, this week’s data are quite variable. We saw levels decline to below the limit of detection on Monday only to rebound to levels slightly lower than last week. We have seen this type of ‘noisy’ variability when we have previously been at low case rates and we think this means, for now, we are steady in viral load. Based on this week and last, it appears that our two-month decline in load has leveled out, but we are not yet seeing an inflection point to an upward trend. This is also consistent with reported case rates that have remained at ~3 new cases per day (7-day running average) for the last week.**
